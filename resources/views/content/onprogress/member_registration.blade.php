...
<div class="card">
  <div class="d-flex justify-content-between">
    <h5 class="card-header">List Member Registration</h5>
  ...
  <div class="table-responsive text-nowrap">
    <table class="table">
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>ling Project</strong></td>
          <td>ling@gmail.com</td>
          <td>EO</td>
...
<hr class="mt-5">
<h5 class="card-header">Add/Update Member</h5>
          ...
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
              ...
              <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
                ...
                <option value="2">Manager Artis</option>
            ...
            <div class="mb-3 col-md-6">
              ...
              <input type="password" class="form-control" id="basic-default-password" placeholder="Password" />
            </div>

            <div class="mb-3 col-md-6">
              <label for="username" class="form-label">Confirm Password</label>
              <input type="password" class="form-control" id="basic-default-confirm-password" placeholder="Confirm Password" />
            </div>
